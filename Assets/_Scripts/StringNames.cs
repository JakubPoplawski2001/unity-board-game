...
public static class USSElementNames
{
    ...
    public const string MAIN_MENU_PLAY_BUTTON = "PlayButton";
    public const string MAIN_MENU_SETTINGS_BUTTON = "SettingsButton";
    public const string MAIN_MENU_EXIT_BUTTON = "ExitButton";

    public const string SELECT_GAME_SCREEN = "SelectGameScreen";
    public const string SELECT_GAME_BACK_BUTTON = "BackButton";
    public const string SELECT_GAME_CREATE_GAME_BUTTON = "CreateGameButton";
